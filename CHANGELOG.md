...
The largest release so far: 60 merged pull requests, 36 of them from [@RichardCao](https://github.com/RichardCao) — the majority of this release — plus the colour customization from [@Pat9496](https://github.com/Pat9496). Viewport-clipped rendering is back on for long documents, tables were rebuilt around content-driven column widths, and font fallback now asks the platform instead of guessing family names.
